    ...
    >
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <a
          ...
          target="_blank"
          referrerPolicy="no-referrer"
          className="mt-auto mb-4 bg-[#FF6900]/10 hover:bg-[#FF6900]/20 border border-[#FF6900]/30 rounded-2xl p-3 text-center transition-all block group/alert"
          id={`direct-whatsapp-alert-${product.id}`}
        >
          <div className="flex items-center justify-center gap-1.5 text-[#FF6600] font-bold text-[11px] leading-snug">
