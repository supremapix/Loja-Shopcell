...
const baseBairrosData: BairroInfo[] = [
  {
    ...
    metaDescription: "Procurando loja de celular no Centro de Curitiba? Compre seu smartphone novo e lacrado com 6 meses de garantia local no Edifício Downtown na Shopcell.",
  ...
  },
  {
    ...
    nome: "Sítio Cercado",
    regiao: "Sul",
    tituloSEO: "Loja de Celular no Sítio Cercado Curitiba | Entrega Hoje e Garantia 6 Meses | Shopcell",
    metaDescription: "Procurando loja de celular no Sítio Cercado? Compre smartphones novos e lacrados com 6 meses de garantia local e entrega via motoboy express na Shopcell.",
  ...
  },
  {
    ...
    metaDescription: "Compre celular no Batel com entrega imediata via motoboy express ou retire com segurança no Centro. Parcelamento em até 12x e garantia local de 6 meses.",
  ...
  },
  {
    ...
    metaDescription: "Adquira seu celular no Água Verde com a Shopcell. Receba seu aparelho lacrado em casa via motoboy ou visite nossa loja no Centro com garantia de 6 meses.",
  ...
  },
  {
    ...
    metaDescription: "Sua loja de celulares para o Bigorrilho / Champagnat. Smartphones novos e lacrados com entrega expressa sob medida. 6 meses de garantia inclusos.",
  ...
  },
  {
    ...
    metaDescription: "Procurando loja de celular no Portão? Compre em até 12x parcelado com garantia de 6 meses. Entrega ultra-rápida via motoboy ou retirada presencial.",
  ...
  },
  {
    ...
    metaDescription: "Adquira smartphones originais e novos no Cabral. Receba em casa hoje via motoboy com total comodidade. Garantia de 6 meses na Shopcell.",
    introducao: "Morar no Cabral une tranquilidade e excelente infraestrutura. Para combinar com esse estilo de vida prático, oferecemos entrega expressa de smartphones com garantia de 6 meses.",
  ...
  },
  {
    ...
    metaDescription: "Celulares lacrados com garantia de 6 meses no Cristo Rei. Compre com quem é referência em avaliações em Curitiba. Entrega imediata hoje.",
  ...
  },
  {
    ...
    metaDescription: "Adquira celulares novos e lacrados no Boqueirão. Garantia de 6 meses e entrega via motoboy express. Compre parcelado em até 12x no cartão.",
    introducao: "O Boqueirão é um dos bairros mais ativos de Curitiba. Atendemos comerciantes e moradores do bairro com entregas diárias de aparelhos celulares com garantia presencial de 6 meses.",
  ...
  },
  {
    ...
    introducao: "Se você reside no Pinheirinho e busca um celular original com excelente preço e garantia real de 6 meses, nós somos a sua melhor opção com entrega rápida pela Linha Verde.",
  ...
  },
  {
    ...
    introducao: "Atendemos com total segurança e agilidade a área da Cidade Industrial de Curitiba (CIC). Entregamos seu novo smartphone com garantia de 6 meses no seu endereço.",
...
const generatedOfficial: BairroInfo[] = OFFICIAL_BAIRROS.map(nome => ({
  ...
  metaDescription: `Adquira seu celular novo no bairro ${nome} em Curitiba com a Shopcell. Entrega imediata via motoboy, pague na entrega e 6 meses de garantia local.`,
  introducao: `A Shopcell atende o bairro ${nome} de Curitiba com total prioridade! Garantimos a entrega expressa do seu celular novo e lacrado na caixa via motoboy. Você realiza o pagamento seguro no ato da entrega com suporte e garantia de 6 meses inclusos.`,
...
const generatedCities: BairroInfo[] = NEARBY_CITIES.map(nome => ({
  ...
  metaDescription: `Sua loja de celulares para ${nome}. Compre smartphones novos e lacrados com entrega expressa para a Região Metropolitana e 6 meses de garantia.`,
  introducao: `Moradores de ${nome} e região contam com o serviço diferenciado da Shopcell! Compre seu smartphone lacrado na caixa com frete rápido e pague na entrega para o motoboy. Todos os nossos produtos têm garantia local de 6 meses.`,
